                ...
                <div class="card  mb-4">
                    <div class="card-header pb-0">
                        ...
                        <div class="d-flex justify-content-end">
                            <span><a href="{{ route('document_type.create') }}"
                        ...
                        <div class="p-3">
                            <table class="table align-items-center mb-0">
                                <thead>
                                    ...
                                    <th class="fw-bolder "> Description
                                    </th>
                                </thead>
                                <tbody>
                                    @php $sr = 1; @endphp
                                    @foreach ($document_types as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="px-4 py-1 ">
                                                    <a href="{{ route('document_type.edit', $row->id) }}"
                                            ...
                                            <td>
                                                <div class="px-4 py-1">
                                                    <p class="fw-bold font-20 mb-0">{{ $row->description }}</p>
                                                </div>
                                            </td>
