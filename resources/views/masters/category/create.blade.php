                        ...
                        <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row px-4">
                                ...
                                <div class="form-group  col-md-12">
                                    ...
                                    <textarea name="details" class="form-control shadow" id="" cols="15" rows="7">{{ old('details') }}</textarea>
                                </div>
                                <div class="row ">
                                    <div class="mt-4 col-md-6">
                                        <a href="{{ Route('categories.index') }}" class="btn bg-gradient-danger btn-sm btn-rounded">Cancel</a>
                                    </div>
                                    <div class=" col-md-6 mt-4 ">
                                        <button type="submit"
                                            class="btn float-end bg-gradient-success btn-sm btn-rounded">Save</button>
                                    </div>
                                </div>
                            </div>
                        </form>
