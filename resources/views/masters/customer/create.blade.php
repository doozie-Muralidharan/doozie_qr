                    ...
                    <form action="{{ route('customers.store') }}" method="POST" class="form-row p-3" enctype="multipart/form-data">
                        ...
                        <div class="row  py-3">
                            <div class="form-group col-md-6">
                                ...
                                <input email="text" name="company_name" class="form-control shadow" value="{{ old('company_name') }}">
                                @error('company_name')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input email="text" name="display_name" value="{{ old('display_name') }}" class="form-control shadow">
                                @error('display_name')
                                <p class="text-danger mt-1 mb-0 text-sm">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group p-2 col-md-6" hidden>
                                <label for="" class=" form-label font-20 fw-bold">Facebook link</label>
                                     <input email="text" name="facebook_link" class="form-control shadow" value="{{ old('facebook_link') }}">
                                @error('facebook_link')
                                <p class="text-danger  ">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group p-2 col-md-6" hidden>
                                <label for="" class=" form-label font-20 fw-bold">Instagram Link</label>
                                   <input email="text" name="instagram_link" class="form-control shadow" value="{{ old('instagram_link') }}">
                            ...
                            <div class="form-group p-2 col-md-6" hidden>
                                <label for="" class=" form-label font-20 fw-bold">Zomato</label>
                                   <input email="text" name="zomato" class="form-control shadow" value="{{ old('zomato') }}">
                                @error('zomato')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group col-md-6" hidden>
                                ...
                                <input email="text" name="webpage_name" value="{{ old('webpage_name') }}" class="form-control shadow">
                                @error('webpage_name')
                                <p class="text-danger mt-1 mb-0 text-sm">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input email="text" name="contact_no" value="{{ old('contact_no') }}" class="form-control shadow">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="website" class=" form-label font-20 fw-bold">Website</label>
                                <input email="text" name="website" value="{{ old('website') }}" class="form-control shadow">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="gst_number" class=" form-label font-20 fw-bold">GST Number</label>
                                <input type="text" id="gst_number" name="gst_number" class="form-control shadow">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="address" class=" form-label font-20 fw-bold">Address</label>
                                <input email="text" name="address" value="{{ old('address') }}" class="form-control shadow">
                            </div>
